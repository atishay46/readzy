  ...
  return (
    <PageLayout>
      <div className="space-y-8">
              ...
              <Card className="relative h-full overflow-hidden transition-all duration-300 hover:shadow-elevated hover:-translate-y-1">
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-teal/10 text-teal transition-colors group-hover:bg-teal group-hover:text-beige">
                      <Icon className="h-6 w-6" />
                    </div>
                    <ArrowRight className="h-5 w-5 text-muted-foreground transition-all group-hover:translate-x-1 group-hover:text-teal" />
                  </div>
                </CardHeader>
                
                <CardContent>
                  <CardTitle className="mb-1 font-heading text-xl text-foreground">
                    {title}
                  </CardTitle>
                  <CardDescription className="mb-4">
                    {description}
                  </CardDescription>
                  <div className="inline-flex items-center rounded-full bg-sky-blue/30 px-3 py-1 text-sm font-medium text-foreground">
                    {stat}
                  </div>
                </CardContent>
              </Card>
        ...
        {/* Quick Stats */}
        <Card className="animate-slide-up border-sky-blue/30" style={{ animationDelay: '300ms' }}>
          <CardHeader>
            <CardTitle className="font-heading text-xl">Reading Progress</CardTitle>
          ...
          <CardContent>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              You can actively read up to 3 books at a time. The oldest book will be moved out when you start reading a new one.
            </p>
          </CardContent>
        </Card>
      </div>
